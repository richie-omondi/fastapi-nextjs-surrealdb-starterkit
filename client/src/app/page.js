  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-around p-24">
      <div className="text-center">
        <h1 className="text-5xl font-extrabold text-purple-600 mb-1 tracking-wide">FastAPI NextJS & SurrealDB</h1>
        <h1 className="text-5xl font-extrabold mb-7 tracking-wide">Starter Kit</h1>
